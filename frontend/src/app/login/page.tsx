            ...
            <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
                <div className="hidden lg:block glass-panel rounded-3xl p-10 relative overflow-hidden">
                    ...
                    <div className="relative">
                        <p className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white dark:bg-slate-700 text-xs font-semibold text-primary-700 dark:text-primary-300 shadow-sm border border-primary-100 dark:border-slate-600 mb-6">
                            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                            Secure session
                        </p>
                        <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white leading-tight">Welcome back to your curated wardrobe</h2>
                        <p className="mt-3 text-slate-600 dark:text-slate-300 leading-relaxed max-w-xl">Sign in to synchronize outfits, favorite looks, and access AI suggestions tailored to your style goals.</p>
                        <div className="mt-6 space-y-3">
                            {[
                                ...
                                <div key={item} className="flex items-start gap-3">
                                    <span className="mt-0.5 flex h-7 w-7 items-center justify-center rounded-full bg-primary-50 dark:bg-primary-900/50 text-primary-700 dark:text-primary-300">
                ...
                <div className="glass-panel rounded-3xl p-8 sm:p-10 border border-white/70 shadow-xl">
                    <div className="flex items-center justify-between mb-6">
                        <div>
<p className="text-xs font-semibold text-primary-600 dark:text-primary-400 uppercase tracking-[0.2em]">Login</p>
                            <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white leading-tight">Access your wardrobe</h2>
                            <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">We'll get you back to styling in seconds.</p>
                        </div>
                        <div className="px-3 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-semibold border border-emerald-100 dark:border-emerald-800">Live</div>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label htmlFor="password" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center justify-between">
                                    <span>Password</span>
                                    <span className="text-xs text-primary-600 dark:text-primary-400 font-semibold">Secure</span>
                                </label>
                                <input
                                    id="password"
                                    name="password"
                    ...
                    <div className="mt-6 text-center text-sm">
                        ...
                        <Link href="/signup" className="font-semibold text-primary-700 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 hover:underline">
                            Sign up
                        </Link>
                    </div>
                </div>
