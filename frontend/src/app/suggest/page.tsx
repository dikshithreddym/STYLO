              ...
              {result.outfit.rationale && (
                <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-blue-900 text-sm mb-1">Why this outfit?</h3>
                      <p className="text-blue-800 text-sm leading-relaxed">{result.outfit.rationale}</p>
                    </div>
                  </div>
                </div>
              )}
