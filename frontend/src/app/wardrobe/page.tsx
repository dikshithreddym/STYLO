    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 py-6 sm:py-12">
        <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:col-span-3">
                {[
                  ...
                  <div key={stat.label} className="bg-white rounded-2xl shadow-sm border border-gray-100/80 p-4 sm:p-6 flex items-center justify-between hover:-translate-y-1 transition-all duration-200">
                    <div>
          ...
          {/* Navigation Tabs */}
          <div className="flex flex-wrap items-center gap-3 bg-white/70 border border-white/80 rounded-2xl px-3 sm:px-4 py-2 shadow-sm mb-6 sm:mb-8">
            {[
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-sm sm:text-base font-semibold transition-all ${activeTab === tab.key ? 'bg-slate-900 text-white shadow-md' : 'text-slate-600 hover:bg-white hover:text-slate-900 border border-transparent hover:border-slate-200'}`}
              >
                {tab.label}
              </button>
            ))}
            <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-500 ml-auto">
          ...
          {activeTab === 'items' && (
            <>
              ...
              <div className="mb-4 sm:mb-6 md:mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                <div className="space-y-1">
                  <p className="text-xs font-semibold text-primary-600 uppercase tracking-[0.2em]">Inventory</p>
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-gray-900">My wardrobe</h2>
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-xs font-semibold">
                      <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                      {displayedItems.length} showing
                    </span>
                    <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-50 text-primary-700 text-xs font-semibold">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex flex-wrap gap-2 justify-end">
                  <button
                    onClick={() => fetchAllWardrobeItems(true)}
                    disabled={loading}
                    className="inline-flex items-center justify-center px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-slate-200 text-slate-700 rounded-xl shadow-sm hover:border-slate-300 hover:-translate-y-0.5 transition-all duration-200 font-semibold text-xs sm:text-sm"
                  ...
                  <button
                    onClick={() => setShowAddModal(true)}
                    className="inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 bg-slate-900 text-white rounded-xl shadow-lg hover:-translate-y-0.5 transition-all duration-200 font-semibold text-sm sm:text-base whitespace-nowrap w-full sm:w-auto"
                  >
              ...
              {/* Filters */}
              <div className="mb-4 sm:mb-6 bg-white rounded-3xl shadow-sm border border-white/80 p-4 sm:p-5 md:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div>
                    <p className="text-sm font-semibold text-slate-900">Filters & sorting</p>
                    <p className="text-xs text-slate-500">Tune the view with quick chips and smart toggles.</p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <button
                      onClick={() => { setShowFavoritesOnly(!showFavoritesOnly); setPage(1) }}
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold border transition-all ${showFavoritesOnly ? 'bg-amber-50 text-amber-700 border-amber-200 shadow-sm' : 'bg-white text-slate-700 border-slate-200 hover:border-slate-300'}`}
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold bg-slate-50 text-slate-700 border border-slate-200 hover:border-slate-300"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                      </svg>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-2.5 text-sm sm:text-base border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-500 text-gray-900 bg-white"
                      />
                    </div>
                  </div>
                  <div className="space-y-1">
