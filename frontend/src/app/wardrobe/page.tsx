              ...
              <div className="mb-6 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-4">
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all ${!categoryFilter 
                        ? 'bg-slate-900 dark:bg-white text-white dark:text-slate-900' 
                        : 'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-600'}`}
                    >
                      All
                    </button>
                    {['top', 'bottom', 'footwear', 'outerwear', 'layer', 'accessories'].map((cat) => (
                      <button
                        key={cat}
                        onClick={() => { setCategoryFilter(categoryFilter === cat ? '' : cat); setPage(1) }}
                        className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all capitalize ${categoryFilter === cat 
                          ? 'bg-slate-900 dark:bg-white text-white dark:text-slate-900' 
                          : 'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-600'}`}
                      >
                        {cat}
                ...
                <div className="flex flex-wrap items-center gap-3 mt-4 pt-4 border-t border-slate-100 dark:border-slate-700">
                  <select
                    ...
                    className="px-3 py-2 text-sm border border-slate-200 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500"
                  >
                  ...
                  <button
                    ...
                    className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all ${showFavoritesOnly 
                  ...
                  <div className="ml-auto flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="px-2 font-medium text-slate-700 dark:text-slate-200">{page}</span>
                      <button
