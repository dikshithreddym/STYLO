...
function ToastContainer({ toasts, removeToast }: { toasts: Toast[]; removeToast: (id: string) => void }) {
    ...
    return (
        <div 
            className="fixed z-[100] flex flex-col gap-2 w-[calc(100%-2rem)] max-w-sm left-1/2 -translate-x-1/2 bottom-[calc(1rem+env(safe-area-inset-bottom))] pointer-events-none sm:right-4 sm:left-auto sm:translate-x-0 sm:w-full sm:bottom-4"
            role="region"
